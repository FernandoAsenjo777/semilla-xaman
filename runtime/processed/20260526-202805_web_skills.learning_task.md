# Microtarea de aprendizaje · web_skills
...
- ID: web_skills
- Fuente: andreasbm/web-skills
- Tipo: repo
- Enseña: mapa de habilidades web
- Pierna: tecnica-operativa
- Módulos inspirados: xq_skill_tree, xq_capability_gap_detector
