# Microtarea de aprendizaje · clean_code_js
...
- ID: clean_code_js
- Fuente: ryanmcdermott/clean-code-javascript
- Tipo: repo
- Enseña: codigo limpio, claridad, mantenibilidad
- Pierna: tecnica-operativa
- Módulos inspirados: xq_code_quality_gate, xq_refactor_advisor
